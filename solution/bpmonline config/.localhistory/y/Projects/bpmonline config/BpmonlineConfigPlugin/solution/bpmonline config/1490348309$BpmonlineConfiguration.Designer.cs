namespace BpmOnlineConfig
{
    partial class BpmonlineConfiguration
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chbUncompressedJS.Click += new System.EventHandler(this.chbUncompressedJS_Click);
			// 
			// edtJSPath
			// 
			...
			this.chbIncludeDependenciesSource.Click += new System.EventHandler(this.chbIncludeDependenciesSource_Click);
			// 

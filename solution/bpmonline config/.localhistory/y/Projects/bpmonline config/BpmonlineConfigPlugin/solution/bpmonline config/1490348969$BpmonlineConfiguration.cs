...
namespace BpmOnlineConfig
{
    public partial class BpmonlineConfiguration : UserControl
    {
        ...
        private void BindSettings(BpmOnlineSettings settings)
        {
			...
			settings.Add(new UncompressedCoreJs(chbIncludeDependenciesSource));
		...
		private void chbUncompressedJS_Click(object sender, EventArgs e) {

		}

		private void chbIncludeDependenciesSource_Click(object sender, EventArgs e) {

namespace BpmOnlineConfig
{
    partial class BpmonlineConfiguration
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chbIncludeDependenciesSource = new System.Windows.Forms.CheckBox();
			...
			this.toolTip.SetToolTip(this.edtWebSocketsPort, "Must be unique");
			// 
			// label2
			// 
			...
			this.edtMaxEntityNameLength.Maximum = new decimal(new int[] {
            256,
            0,
            0,
            0});
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.chbIncludeDependenciesSource);
			...
			// 
			// chbIncludeDependenciesSource
			// 
			this.chbIncludeDependenciesSource.AutoSize = true;
			this.chbIncludeDependenciesSource.Location = new System.Drawing.Point(270, 28);
			this.chbIncludeDependenciesSource.Name = "chbIncludeDependenciesSource";
			this.chbIncludeDependenciesSource.Size = new System.Drawing.Size(192, 17);
			this.chbIncludeDependenciesSource.TabIndex = 5;
			this.chbIncludeDependenciesSource.Text = "Use Include Dependencies Source";
			this.chbIncludeDependenciesSource.UseVisualStyleBackColor = true;
			// 
			// chbUncompressedJS
			// 
			...
			this.toolTip.SetToolTip(this.edtApplicatinName, "Application name is the SQL Server queries");
			// 
			// label4
			// 
			...
			this.toolTip.SetToolTip(this.chbSchedulerDb, "For the query profiling purposes");
		...
		private System.Windows.Forms.CheckBox chbIncludeDependenciesSource;
    }
}
